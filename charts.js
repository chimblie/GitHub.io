...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var gaugeArry = data.metadata.filter(metadataObject => metadataObject.id == sample)
    console.log("metadata", gaugeArry)
    // Deliverable 1: 5. Create a variable that holds the first sample in the array.
    var results = filteredSamples[0]
    console.log(results)
    // Deliverable 3: 2. Create a variable that holds the first sample in the metadata array.
    var gaugeResult = gaugeArry[0]
    ...
    var barLayout = {
      title: {
        text: "Top 10 Bacterias Cultures Found",
        font: { size: 20 },
        paper_bgcolor: 'rgba(224, 233, 234, 1)',
        plot_bgcolor: 'rgba(224, 233, 234, 1)',
